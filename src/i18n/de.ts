export default {
  accidentally_closed_info_msgs:
    'Wenn Sie versehentlich eine Infobox mit einem Hinweis geschlossen haben, können Sie alle wiederherstellen, indem Sie hier klicken:',
  ...
  create_your_first_ts: 'Erstelle Deine erste Tabset-Sammlung',
  ...
  optionally: 'Optional:',
  provide_name_add_later: "Der Name der Sammlung, z.B. 'Urlaub', 'Musik', ...",
  ...
  settings_adjust_general_appearance:
    'Auf dieser Einstellungsseite können Sie das allgemeine Erscheinungsbild der Tabsets-Erweiterung anpassen.',
  ...
  warnings_info:
    'Die Warnungen beginnen, wenn die Mindestanzahl offener Tabs erreicht ist. Wenn das Maximum erreicht ist, wird der Balken rot.',
