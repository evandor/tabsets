<template>
  ...
  <q-item-section
    ...
    <!-- tabsets -->
    <q-item-label v-if="!props.simpleUi" class="text-grey-10" text-subtitle1>
      <q-chip
        class="cursor-pointer q-ml-none q-mr-sm q-mt-md"
        size="9px"
        clickable
        icon="tab"
...
const avatar = ref<string | undefined>(
  (LocalStorage.getItem(SHARING_AVATAR_IDENT) as string) || 'http://www.gravatar.com/avatar',
)
