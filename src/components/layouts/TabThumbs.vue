<template>
  ...
  <vue-draggable-next
    ...
    <div
      ...
      <TabThumbWidget :key="props.group + '__' + tab.id" :tab="tabAsTab(tab)" :highlightUrl="highlightUrl" />
...
import TabThumbWidget from "src/components/widgets/TabThumbWidget.vue"
