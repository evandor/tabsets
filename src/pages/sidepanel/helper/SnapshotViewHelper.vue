<template>
  <div class="row q-ma-none q-mt-lg">
    ...
    <div class="col-2 text-caption text-right">
      <q-icon
        v-if="props.extension === BlobType.HTML"
        name="o_edit"
...
const editHtml = () =>
  window.open(
    chrome.runtime.getURL(
      `www/index.html#/mainpanel/${props.extension}/${props.snapshotId}?edit=true`,
    ),
  )

const openMhtml = () =>
  window.open(
    chrome.runtime.getURL(`www/index.html#/mainpanel/${props.extension}/${props.snapshotId}`),
  )
