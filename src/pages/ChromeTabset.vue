...
<!--        </div>-->
<!--        &lt;!&ndash;      <div class="row justify-start items-baseline">&ndash;&gt;-->
<!--        &lt;!&ndash;        <div class="text-caption">You can save your current tabs and give the new set a name</div>&ndash;&gt;-->
<!--        &lt;!&ndash;      </div>&ndash;&gt;-->
<!--      </q-toolbar-title>-->
...
<!--                &lt;!&ndash;                <q-btn label="create new tabset" v-if="expanded" @click="newTabsetFrom(group.title, group.id)"/>&ndash;&gt;-->
...
<!--      &lt;!&ndash; rest: neither pinned, grouped, or pending &ndash;&gt;-->
<!--      <q-expansion-item-->
<!--        v-if="showOtherTabs()"-->
<!--        icon="tabs"-->
<!--        default-opened-->
