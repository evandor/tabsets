...
(function(factory, root) {
    if (typeof define == "function" && define.amd) {
        console.log("AMD. Register as an anonymous module with a dependency on Rangy.")
        define(["./rangy-core"], factory);
    } else if (typeof module != "undefined" && typeof exports == "object") {
        console.log("Node/CommonJS style")
        module.exports = factory( require("rangy") );
    } else {
        console.log("No AMD or CommonJS support so we use the rangy property of root (probably the global variable)", root, root.rangy)
        factory(root.rangy);
    }
})(function(rangy) {
